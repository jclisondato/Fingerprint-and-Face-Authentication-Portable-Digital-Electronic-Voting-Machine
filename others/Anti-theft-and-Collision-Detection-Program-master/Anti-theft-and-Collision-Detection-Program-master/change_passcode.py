...
# Form implementation generated from reading ui file 'change_passcode.ui'
#
...
class Ui_change_passcode(object):
    def setupUi(self, change_passcode):
        change_passcode.setObjectName("change_passcode")
        change_passcode.resize(1344, 908)
        change_passcode.setStyleSheet("background-image: url(\'a.jpg\');\n"
"")
        self.centralwidget = QtWidgets.QWidget(change_passcode)
...
"border: 3px solid red;")
        ...
        self.change_passcode_button = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.change_passcode_button.sizePolicy().hasHeightForWidth())
        self.change_passcode_button.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.change_passcode_button.setFont(font)
        self.change_passcode_button.setStyleSheet("color: white;\n"
"border: 3px solid red;")
        self.change_passcode_button.setObjectName("change_passcode_button")
        self.gridLayout.addWidget(self.change_passcode_button, 2, 3, 1, 1)
        ...
        change_passcode.setCentralWidget(self.centralwidget)

        self.retranslateUi(change_passcode)
        QtCore.QMetaObject.connectSlotsByName(change_passcode)

    def retranslateUi(self, change_passcode):
        _translate = QtCore.QCoreApplication.translate
        change_passcode.setWindowTitle(_translate("change_passcode", "change_passcode"))
        self.backtomainmenu_button.setText(_translate("change_passcode", "Back to Security"))
        self.label_2.setText(_translate("change_passcode", "ENTER NEW PASSCODE"))
        self.Num_7.setText(_translate("change_passcode", "7"))
        self.Num_8.setText(_translate("change_passcode", "8"))
        self.Num_9.setText(_translate("change_passcode", "9"))
        self.back_button.setText(_translate("change_passcode", "BACK"))
        self.Num_4.setText(_translate("change_passcode", "4"))
        self.Num_5.setText(_translate("change_passcode", "5"))
        self.Num_6.setText(_translate("change_passcode", "6"))
        self.Num_0.setText(_translate("change_passcode", "0"))
        self.Num_1.setText(_translate("change_passcode", "1"))
        self.Num_2.setText(_translate("change_passcode", "2"))
        self.Num_3.setText(_translate("change_passcode", "3"))
        self.change_passcode_button.setText(_translate("change_passcode", "Change Passcode"))
...
if __name__ == "__main__":
    ...
    change_passcode = QtWidgets.QMainWindow()
    ui = Ui_change_passcode()
    ui.setupUi(change_passcode)
