...
def face_detection(imagepath):
	...
	face_cascade = cv.CascadeClassifier('others/Face-Recognition-Haar-LBPH-master/Face-Recognition-Haar-LBPH-master/opencvfiles/haarcascade_frontalface_alt.xml')
